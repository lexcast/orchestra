...
var scheduleTracking = function(channel, track, note, currentTime, offset, message, velocity, time) {
		...
		switch (event.subtype) {
			...
			case 'noteOn':
				...
				eventQueue.push({
				    ...
				    interval: scheduleTracking(channelId, obj[0].track, note, queuedTime + midi.startDelay, offset - foffset, 144, event.velocity)
				});
				messages++;
				break;
			case 'noteOff':
				...
				eventQueue.push({
				    ...
				    interval: scheduleTracking(channelId, obj[0].track, note, queuedTime, offset - foffset, 128, 0)
				});
				break;
			default:
				break;
