...
const Details = ({ song }) => {
  ...
  return (
    <div className="bg-yellow-50 flex w-64 h-16 rounded-lg overflow-hidden mb-6 relative md:absolute bottom-0 left-0 md:m-4 opacity-75 hover:opacity-100 hover:shadow-lg">
      <div
