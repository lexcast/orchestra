...
const IconsAttribution = ({ setSidebar }) => {
  ...
  return (
    <div ref={el} className="attribution bg-yellow-100 text-left absolute top-0 left-0 w-64 h-screen overflow-y-auto shadow-lg px-4 py-2 font-sans text-xs text-gray-700 font-normal">
